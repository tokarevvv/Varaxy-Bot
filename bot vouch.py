...
VOUCH_CHANNEL_NAME = "avis-proofs"  # nom du salon où les avis /vouch sont publiés
...
async def vouch(
    ...
    await interaction.response.send_message(f"✅ Ton avis a été publié dans #{VOUCH_CHANNEL_NAME} !", ephemeral=True)
